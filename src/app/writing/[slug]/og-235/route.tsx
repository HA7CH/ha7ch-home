      ...
      <div style={{ width: "100%", height: "100%", background: "#ffffff", display: "flex", flexDirection: "column", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "absolute", inset: 0, padding: "28px 40px 140px", display: "flex", flexDirection: "column", gap: "14px", overflow: "hidden" }}>
          {paragraphs.map((para, i) => (
            <div key={i} style={{ fontSize: 22, fontWeight: 300, color: "#111111", lineHeight: 1.6, fontFamily: "Inter" }}>
              {para}
            </div>
          ))}
        </div>
        ...
        {/* Title bottom-left */}
        <div style={{ position: "absolute", bottom: 48, left: 40, display: "flex", fontSize: titleFontSize, fontWeight: 600, fontFamily: "Inter", color: "#111111", letterSpacing: "-0.02em", lineHeight: 1 }}>
          {title}
        </div>

        {/* Logo bottom-right */}
        <div style={{ position: "absolute", bottom: 50, right: 64, display: "flex", alignItems: "center" }}>
