...
const article: Article = {
  ...
  zh: [
    ...
    "YC 是加速器。HA7CH 更像是引擎。",
    "YC 会问：谁值得投资？HA7CH 会问：谁可以被点燃？",
    "在产品极易被复制的世界里，护城河不再是产品本身。护城河是你能聚集、点燃、一起向前走的人。",
    "---",
    "所以我们现在在做什么？",
  ...
  en: [
    ...
    "YC asks: \"Who is worth investing in?\" HA7CH asks: \"Who can be ignited?\"",
    "In a world where products are easy to copy, the moat is no longer the product itself. The moat is the people you can gather, energize, and move forward together.",
    "---",
